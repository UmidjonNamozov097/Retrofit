...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    try {
                        ...
                        cat.setCategory(jsonObject.getString("kategory"));
                        category.add(cat);
    ...
    public void adapterPush(ArrayList<Category> category) {
    ...
    public void addCategory(View v) {
        ...
        judul.setText("Succefull Kategoriya");
    ...
    private void Submit(final  String data) {
        StringRequest request=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(getApplicationContext(), "Data Berhaliditannddn", Toast.LENGTH_LONG).show();
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(getApplicationContext(), "Data Gagel", Toast.LENGTH_LONG).show();
